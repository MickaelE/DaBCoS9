...
//UPDATE
using T = DaBCoS.Engine.TableDifference;
...
{
	/// <summary>
	/// Strongly typed collection for TableDifference Entity
	/// </summary>
	public class TableDifferenceCollection : DifferenceCollection
	{
		
		#region Internal Classes

		//UPDATE
		public class TableDifferenceCollectionEnumerator : System.Collections.IEnumerator
		{
			...
			//UPDATE
			private TableDifferenceCollection _collection;
		...
		public TableDifferenceCollection() : base(){}
	
		public TableDifferenceCollection(ArrayList array)
		{
		...
		//-------------------------------------------------------------------------------------------
		//UPDATE
		public new TableDifferenceCollectionEnumerator GetEnumerator()
		{
			return new TableDifferenceCollectionEnumerator(this);
		}
