...
//UPDATE
using T = DaBCoS.Engine.Difference;
...
{
	/// <summary>
	/// Strongly typed collection for Job Entity
	/// </summary>
	public class DifferenceCollection : System.Collections.CollectionBase
	{
		
		#region Constructor(s)

		public DifferenceCollection() : base(){}

		public DifferenceCollection(ArrayList array)
		{
		...
		public int CountByOutcome(Difference.DifferenceOutcome outcome)
		{
			int i=0;
			foreach(Difference difference in this)
			{
				if (difference.Outcome==outcome)
				{
					i++;
				}
			}
		...
		public class DifferenceCollectionEnumerator : System.Collections.IEnumerator
		{
			...
			//UPDATE
			private DifferenceCollection _collection;
