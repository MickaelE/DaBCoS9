...
//UPDATE
using T = DifferenceEngine.TextLine;
...
namespace DifferenceEngine
{
	...
	public class TextLineCollection : System.Collections.CollectionBase
	{
		...
		public TextLineCollection() : base(){}

		public TextLineCollection(ArrayList array)
		{
		...
		//-------------------------------------------------------------------------------------------
		//UPDATE
		public new TextLineCollectionEnumerator GetEnumerator()
		{
			return new TextLineCollectionEnumerator(this);
		}
		...
		/// <returns></returns>
		public TextLineCollection Sort(string sortParameter, SortDirection sortDirection)
		{
			...
			//UPDATE
			return new TextLineCollection(sortList);
		}
		...
		public class TextLineCollectionEnumerator : System.Collections.IEnumerator
		{
	
			#region Constructor(s)

			//UPDATE
			internal TextLineCollectionEnumerator (TextLineCollection collection)
			{
				_index = -1;
			...
			//UPDATE
			private TextLineCollection _collection;
