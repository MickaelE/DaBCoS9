...
namespace DaBCoS
{
	...
	public class Results : System.Windows.Forms.Form
	{
		...
		public Results(Difference difference):this(difference.LeftText, difference.RightText, difference.DifferenceResults, difference.TimeTaken){}
		...
		private void InitializeComponent()
		{
			...
			this.KeyPress += new System.Windows.Forms.KeyPressEventHandler(this.Results_KeyPress);
		...
		private void Results_KeyPress(object sender, System.Windows.Forms.KeyPressEventArgs e)
		{
			switch (e.KeyChar)
			{
				case (char)27:
